...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"EventListeners\": () => (/* binding */ EventListeners)\n/* harmony export */ });\n/* harmony import */ var _const_keyCodesEng__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const/keyCodesEng */ \"./src/const/keyCodesEng.js\");\n/* harmony import */ var _utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/keyBindsUtils */ \"./src/utils/keyBindsUtils.js\");\n/* harmony import */ var _utils_storage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/storage */ \"./src/utils/storage.js\");\n/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./keyboard */ \"./src/modules/keyboard.js\");\n/* harmony import */ var _Key__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Key */ \"./src/modules/Key.js\");\n\n\n\n\n\nclass EventListeners {\n  constructor() {}\n\n  listeners() {\n    //вывод текста в textrea \n    window.addEventListener('keydown', function (e) {\n      let arr;\n      _const_keyCodesEng__WEBPACK_IMPORTED_MODULE_0__.keyCodesEng.forEach(el => {\n        if (el.keyCode == e.keyCode) {\n          arr = el;\n        }\n      });\n\n      if (arr != undefined) {\n        document.getElementById('keyboard_input').focus();\n        let key = (0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getLanguageKeys)().find(el => el.code === e.code);\n        e.preventDefault();\n        new _Key__WEBPACK_IMPORTED_MODULE_4__.Key(key).pressKey();\n      }\n    });\n    document.addEventListener('mousedown', function (e) {\n      if (e.target.id != 'keyboard_wrapper' && e.target.id != 'keyboard_input' && e.target.id != '') {\n        document.getElementById('keyboard_input').focus();\n        let key = (0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getLanguageKeys)().find(el => el.code === e.target.id);\n        e.preventDefault();\n        new _Key__WEBPACK_IMPORTED_MODULE_4__.Key(key).pressKey();\n      }\n    }); //добавление класса active кнопкам\n\n    let arr = [];\n    document.addEventListener('keydown', function (event) {\n      _const_keyCodesEng__WEBPACK_IMPORTED_MODULE_0__.keyCodesEng.forEach(el => {\n        if (el.keyCode == event.keyCode) {\n          arr.push(el);\n        }\n      });\n\n      if (arr.length !== 0) {\n        document.querySelector(`#${event.code}`).classList.add('active');\n      }\n    });\n    document.addEventListener('keyup', function (event) {\n      if (arr.length != 0) {\n        document.querySelector(`#${event.code}`).classList.remove('active');\n        arr.pop();\n      }\n    });\n    let activeChar; //переменная для того же элемента, по которому кликнули, чтобы форма клавиши возвращалась\n\n    document.addEventListener('mousedown', function (event) {\n      if (event.target.id != 'keyboard_wrapper' && event.target.id != 'keyboard_input' && event.target.id != '') {\n        activeChar = document.querySelector(`#${event.target.id}`);\n        document.querySelector(`#${event.target.id}`).classList.add('active');\n      }\n    });\n    document.addEventListener('mouseup', function (event) {\n      if (activeChar != undefined) {\n        activeChar.classList.remove('active');\n      }\n    }); //переключение языка\n\n    document.addEventListener('keydown', function (event) {\n      if ((event.shiftKey || event.ctrlKey) && event.altKey) {\n        if ((0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.get)('lang') === 'en') {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('lang', 'ru');\n        } else {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('lang', 'en');\n        }\n\n        let keyboard = new _keyboard__WEBPACK_IMPORTED_MODULE_3__.Keyboard((0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getCapsKeys)());\n        keyboard.render();\n      }\n    }); //CapsLock\n\n    document.addEventListener('keydown', function (event) {\n      if (event.code === 'CapsLock') {\n        if ((0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.get)('isCapsLock') === 'false') {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isCapsLock', 'true');\n        } else {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isCapsLock', 'false');\n        } // const capsLockOption = get('isCapsLock');\n        // set('isCapsLock', !capsLockOption)\n\n\n        let keyboard = new _keyboard__WEBPACK_IMPORTED_MODULE_3__.Keyboard((0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getCapsKeys)());\n        keyboard.render();\n      }\n    });\n    let shiftOn = false; // флаг для одного действия shift в keydown \n    //Shift подписка\n\n    document.addEventListener('keydown', function (event) {\n      if (shiftOn === false) {\n        if (event.code === 'ShiftLeft' || event.code === 'ShiftRight') {\n          if ((0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.get)('isShift') === 'false') {\n            (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isShift', 'true');\n          } else {\n            (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isShift', 'false');\n          }\n\n          let keyboard = new _keyboard__WEBPACK_IMPORTED_MODULE_3__.Keyboard((0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getShiftKeys)());\n          keyboard.render();\n        }\n      }\n\n      shiftOn = true;\n    }); //Shift отписка\n\n    document.addEventListener('keyup', function (event) {\n      if (event.code === 'ShiftLeft' || event.code === 'ShiftRight') {\n        if ((0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.get)('isShift') === 'false') {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isShift', 'true');\n        } else {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isShift', 'false');\n        }\n\n        let keyboard = new _keyboard__WEBPACK_IMPORTED_MODULE_3__.Keyboard((0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getShiftKeys)());\n        keyboard.render();\n      }\n\n      shiftOn = false;\n    }); //переключение языка на Win по клику мышкой\n\n    document.addEventListener('click', function (event) {\n      if (event.target.id === 'MetaLeft') {\n        if ((0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.get)('lang') === 'en') {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('lang', 'ru');\n        } else {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('lang', 'en');\n        }\n\n        let keyboard = new _keyboard__WEBPACK_IMPORTED_MODULE_3__.Keyboard((0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getShiftKeys)());\n        keyboard.render();\n      } //CapsLock\n\n\n      if (event.target.id === 'CapsLock') {\n        if ((0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.get)('isCapsLock') === 'false') {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isCapsLock', 'true');\n        } else {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isCapsLock', 'false');\n        }\n\n        let keyboard = new _keyboard__WEBPACK_IMPORTED_MODULE_3__.Keyboard((0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getCapsKeys)());\n        keyboard.render();\n      } //Shift\n\n\n      if (event.target.id === 'ShiftLeft' || event.target.id === 'ShiftRight') {\n        if ((0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.get)('isShift') === 'false') {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isShift', 'true');\n        } else {\n          (0,_utils_storage__WEBPACK_IMPORTED_MODULE_2__.set)('isShift', 'false');\n        }\n\n        let keyboard = new _keyboard__WEBPACK_IMPORTED_MODULE_3__.Keyboard((0,_utils_keyBindsUtils__WEBPACK_IMPORTED_MODULE_1__.getShiftKeys)());\n        keyboard.render();\n      }\n    });\n  }\n\n  isListenersOn() {\n    this.listeners();\n  }\n\n}\n\n//# sourceURL=webpack://virtual-keyboard/./src/modules/eventListeners.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("d259ed05a3f93070e516")
/******/ 	})();
/******/ 	
